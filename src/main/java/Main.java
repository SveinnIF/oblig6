...
public class Main {
    public static void main(String[] args){
        ...
        observationList.put("GOMP observation",new Observation("GOMP observation","Svon", untariansList.get("GOMP"),biomeList.get("taterLand"),"https://media.discordapp.net/attachments/578228794939408384/701739929180569661/unknown.png?width=607&height=502","24.3.2337",1,"it was eating"));
        observationList.put("GRUBL observation", new Observation("GRUBL observation","Barg Bjornar Birtleby",untariansList.get("GRUBL"),biomeList.get("tralleball"),"https://discordapp.com/channels/@me/578228794939408384/701740078975811604","24.11.2337",1,"my god what a beauty, those legs are to die for"));
        observationList.put("sippidipp observation", new Observation("Sippidipp observation","Hans-Henning Bjorrebill",kushList.get("sippdipp"),biomeList.get("enFlaskeLim"),"https://media.discordapp.net/attachments/578228794939408384/701741108748615760/unknown.png","12.12.2337",5,"now thise are some scary plants"));
        observationList.put("Klomp observation", new Observation("Klomp observation","Gjens Gjorerett",kushList.get("Klomp"),biomeList.get("blod"),"https://media.discordapp.net/attachments/578228794939408384/701740878720532540/unknown.png?width=450&height=502","2.2.2338",12,"seem catching other swiming animals and eating them with their long mouth arms"));
        observationList.put("ORGALORG",new Observation("ORGALORG","Harry Hole",septansList.get("ORGALORG"),biomeList.get("hemsedal"),"https://media.discordapp.net/attachments/578228794939408384/701739812297900092/unknown.png","23.523.3425",500,"THEY ARE EVERYWHERE! THEY ARE EATING FRANK! MY GOD THE HUMANITY!"));
        observationList.put("Kampian observation", new Observation("Kampian observation","Sopple Jan Bergstrom",septansList.get("Kampian"),biomeList.get("HAHAHAHAHA"),"jeg hadde bilde av denne også, var liksom en tusenben greie men da må jeg slå på store pc'n igjen fordi jeg glemte å sende den over og det gidder jeg ikke nå. men det var vel ikke så viktig i oppgaven uansett","12.65.7654",24,"real cool beans these buggers are, wouldn'da lovva ben etin bya onea dam"));
        ...
        app.get("/", ctx -> ctx.result("go to /api/observations"));
    }
}